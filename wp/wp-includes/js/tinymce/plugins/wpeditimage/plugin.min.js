...
tinymce.PluginManager.add( 'wpeditimage', function( editor ) {
    ...
    function markImage( img ) {
        var imageMarker = new ImageMarker(img, editor);
        imageMarker.manageMarkers();
        window.im = imageMarker;
    }
    ...
    function addToolbar( node ) {
        ...
        toolbarHtml = '<i class="dashicons dashicons-edit edit" data-mce-bogus="all"></i>' +
            ...
            '<i class="dashicons dashicons-tag marker" data-mce-bogus="all"></i>';
